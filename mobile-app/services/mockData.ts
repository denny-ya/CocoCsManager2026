...
export const MOCK_BS_RESULTS: BsSearchResult[] = [
    { id: '1', code: 'HYM001', storeName: '가락점', model: 'WM-F700B', symptom: '세탁 안됨', status: '완료', date: '2026-02-10' },
    { id: '2', code: 'HYM002', storeName: '강남점', model: 'REF-G900S', symptom: '냉각 불량', status: '진행중', date: '2026-02-11' },
    { id: '3', code: 'HYM003', storeName: '잠실점', model: 'AC-W500K', symptom: '소음 발생', status: '대기', date: '2026-02-12' },
    { id: '4', code: 'HYM004', storeName: '목동점', model: 'DW-H300L', symptom: '누수', status: '완료', date: '2026-02-09' },
    { id: '5', code: 'HYM005', storeName: '신도림점', model: 'WM-F700B', symptom: '탈수 이상', status: '진행중', date: '2026-02-11' },
];
